    ...
    <div className='flex justify-center mt-20'>
      <div>
        <form onSubmit={handleSubmit(loginhandler)}
          className='rounded-3xl shadow-[0px_0px_45px_lightblue] flex flex-col px-5 sm:px-10 py-4 sm:py-10 sm:w-100 sm:h-125
     mx-10 mt-10 bg-gradient-to-tl from blue-500 to-blue-500 '
        >
          ...
          <input type="text" placeholder="john doe"
            className='text-2xl font-thin border-b-2 px-2 sm:px-4 py-2 sm:py-3 focus:outline-none
          ...
          <button className='bg-pink-950 border border-transparent transition-all hover:bg-transparent hover:border-white duration-200 w-30 px-5 py-2 rounded-3xl mt-5 mx-25 mb-5'>Signin</button>
