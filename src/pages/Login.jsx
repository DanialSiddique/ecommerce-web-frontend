...
const Login = () => {
  ...
  return (
    <div className='flex justify-center mt-20'>
      ...
      className='rounded-3xl shadow-[15px_5px_30px_lightblue] flex flex-col gap-3 sm:gap-0 px-10 py-10 sm:py-15 w-80 sm:w-100 h-90 sm:h-100
     mx-10 mt-10 bg-gradient-to-tl from blue-500 to-blue-500' 
      >
        <input type="email" placeholder="john@doe" 
        {...register("email",{
            required:"email is required"}
          )} className='my-2 sm:my-5 text-2xl font-thin border-b-2 px-2 sm:px-4 py-2 sm:py-3 focus:outline-none
          transition-all duration-200 hover:scale-[1.015] autofill:bg-transparent'
        />
        <input type="password" placeholder="********" 
        {...register("password",{
            required:"password is required"
        })} className='my-5 text-2xl font-thin border-b-2 px-2 py-2 sm:px-4 sm:py-3 focus:outline-none
